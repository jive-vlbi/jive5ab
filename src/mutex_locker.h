...
struct mutex_locker {
    ...
    ~mutex_locker() THROWS(pthreadexception); // unlocks
...
struct mutex_unlocker {
    ...
    ~mutex_unlocker() THROWS(pthreadexception); // locks
...
struct rw_write_locker {
    ...
    ~rw_write_locker() THROWS(pthreadexception); // unlocks
...
struct rw_read_locker {
    ...
    ~rw_read_locker() THROWS(pthreadexception); // unlocks
