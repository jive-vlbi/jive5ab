...
struct data_check_type {
    ...
    // trackbitrate to headersearch_type::UNKNOWN_TRACKBITRATE,
    // time.tv_subsecond to highrestime_type::UNKNOWN_SUBSECOND
    //   => on a default instance is_partial() guaranteed to return .TRUE.
    data_check_type();
