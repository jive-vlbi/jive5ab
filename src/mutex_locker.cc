...
mutex_locker::~mutex_locker( ) throw(pthreadexception) {
...
mutex_unlocker::~mutex_unlocker( ) throw(pthreadexception) {
    PTHREAD_CALL( ::pthread_mutex_lock(&mutex) );
}
...
rw_write_locker::~rw_write_locker( ) throw(pthreadexception) {
...
rw_read_locker::~rw_read_locker( ) throw(pthreadexception) {
    PTHREAD_CALL( ::pthread_rwlock_unlock(&mutex) );
}
